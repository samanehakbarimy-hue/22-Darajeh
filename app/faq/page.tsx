...
const FAQS: { q: string; a: React.ReactNode }[] = [
  ...
  },
  {
    ...
    a: (
      <>
        ...
        نداده، می‌توانی متن درخواستت را عوض کنی. بعد از تأیید، لینک جلسه در بخش
        «درخواست‌های من» برایت نمایش داده می‌شود.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    a: (
      <>
        از{" "}
        <Link href="/signup/mentor" className="text-brand hover:underline">
          همین‌جا
        </Link>{" "}
