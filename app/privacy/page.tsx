    ...
    <div className="mx-auto w-full max-w-2xl flex-1 px-6 py-12">
      ...
      <Section title="چه اطلاعاتی ذخیره می‌کنیم">
        <p>
          ...
          وارد شوی، نام و عکس از همان‌جا گرفته می‌شود و ما یک نسخه از عکس را روی
          سرور خودمان نگه می‌داریم تا بعداً از بین نرود.
        </p>
        <p>
      ...
      <Section title="چه کسی چه چیزی را می‌بیند">
        ...
        <p>
          ...
          ادمین آن را می‌بینند. لینک جلسه فقط بعد از تأیید درخواست، به همان شخصی
          که رزرو کرده نشان داده می‌شود.
        </p>
        <p>متن درخواستت را فقط خودت و متخصصی که برایش فرستادی می‌بینید.</p>
      </Section>
