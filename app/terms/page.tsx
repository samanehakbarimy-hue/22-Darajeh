...
export const metadata: Metadata = {
  title: "قوانین استفاده — جاب‌آموز",
  description: "چه انتظاری از جاب‌آموز داشته باش و ما چه انتظاری از تو داریم.",
};
  ...
  return (
    <div className="mx-auto w-full max-w-2xl flex-1 px-6 py-12">
      ...
      <Section title="اگر درخواست جلسه می‌دهی">
        <p>
          در متن معرفی بنویس واقعاً دنبال چه هستی؛ کارشناس بر همان اساس تصمیم
      ...
      <Section title="مسئولیت">
        <p>
          آنچه در یک جلسه گفته می‌شود نظر شخصی همان کارشناس است، نه توصیه رسمی
          جاب‌آموز. تصمیم‌های شغلی با خودت است.
        </p>
      </Section>
