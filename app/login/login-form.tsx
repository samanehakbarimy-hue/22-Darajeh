        ...
        <div className="mt-6 rounded-lg border border-card-border bg-card p-4 text-sm">
          ...
          <form action={resendAction} className="mt-3 flex gap-2">
            <input
              ...
              required
              placeholder="ایمیل"
              className="flex-1 rounded-lg border border-card-border bg-background px-3 py-2 text-sm outline-none focus:border-brand focus:ring-2 focus:ring-brand/20"
            />
            <button
